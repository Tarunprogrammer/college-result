...
if (isset($_POST['login'])) {
    ...
    if ($user && password_verify($password, $user['password'])) {
        if ($user['role'] === 'admin') {
            ...
            // This is a generic login page now, let's adjust the logic slightly
            // For a student login, you would redirect them to a student page.
            // For now, we keep the admin-only logic but might adjust error message.
            $error = "Access denied. Only admins can log in via this portal.";
        }
    } else {
...
<head>
    ...
    <title>Admin Login - DRK College</title>
