...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($password !== $confirm_password) {
        ...
        $stmt = $conn->prepare("INSERT INTO users (full_name, hall_ticket_no, email, password) VALUES (?, ?, ?, ?)");
        $stmt->bind_param("ssss", $full_name, $hall_ticket, $email, $hashed_password);
        ...
        if ($stmt->execute()) {
            ...
            $error = "Registration failed. Hall ticket or email may already be registered.";
        }
    }
}
?>
...
<head>
    ...
    <title>Register - DRK College</title>
    ...
    <div class="card">
        ...
        <form method="POST" action="">
            ...
            <div style="margin-top: 20px; text-align: center;">
                <p>Already have an account? <a href="login.php" style="color: var(--accent-color); text-decoration: none;">Login here</a></p>
            </div>
        </form>
    </div>
</div>
